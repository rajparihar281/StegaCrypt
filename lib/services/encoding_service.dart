...
class EncodingService {
  ...
  Future<String?> encodeDataIntoImage(String text, File imageFile) async {
    try {
      ...
      String fileName = 'encoded_image${DateTime.now().millisecondsSinceEpoch}.png';
  ...
  // Modify the 2nd least significant bit
  int _set2ndLSB(int colorValue, bool bit) {
    return (colorValue & 0xFD) | (bit ? 2 : 0);
  }
